...
import { FinancialTransaction, TransactionCategory } from '@core/models/types.js';
import { autoCategorizeConcepto, detectFugaInTransaction } from '@core/services/bankImportService.js';
